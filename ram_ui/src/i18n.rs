...
fn pt_br(key: &'static str) -> Option<&'static str> {
    Some(match key {
        ...
        "KNT Manager asks for it every time it starts. If you forget it, the accounts cannot be recovered." => "O KNT Manager pede a senha sempre que inicia. Se voc\u{00EA} esquec\u{00EA}-la, as contas n\u{00E3}o podem ser recuperadas.",
        ...
        // ---- Central / Account Groups ----
        "Central" => "Central",
        "Servers" => "Servidores",
        "Account groups" => "Grupos de contas",
        "Organize accounts by game and run several accounts in a coordinated way." => "Organize contas por jogo e execute v\u{00E1}rias contas de forma coordenada.",
        "Create group" => "Criar grupo",
        "Edit group" => "Editar grupo",
        "Delete group" => "Excluir grupo",
        "Group name" => "Nome do grupo",
        "e.g. Farm Principal" => "ex.: Farm Principal",
        "Accounts" => "Contas",
        "Accounts selected" => "Contas selecionadas",
        "{} account(s)" => "{} conta(s)",
        "Join together" => "Entrar juntas",
        "Distribute across servers" => "Distribuir entre servidores",
        "Puts each account in a different server." => "Coloca cada conta em um servidor diferente.",
        "Servers found" => "Servidores encontrados",
        "Looking for server" => "Procurando servidor",
        "Server found" => "Servidor encontrado",
        "Entering" => "Entrando",
        "Distribution complete" => "Distribui\u{00E7}\u{00E3}o conclu\u{00ED}da",
        "Distribution partially complete" => "Distribui\u{00E7}\u{00E3}o parcialmente conclu\u{00ED}da",
        "Not enough servers" => "Servidores insuficientes",
        "No game configured" => "Nenhum jogo configurado",
        "Could not identify this game" => "N\u{00E3}o foi poss\u{00ED}vel identificar o jogo",
        "Could not query the servers" => "N\u{00E3}o foi poss\u{00ED}vel consultar os servidores",
        "No compatible server found" => "Nenhum servidor compat\u{00ED}vel encontrado",
        "Not enough compatible servers were found for all accounts." => "N\u{00E3}o foram encontrados servidores suficientes para todas as contas.",
        "Could not start this account" => "N\u{00E3}o foi poss\u{00ED}vel iniciar esta conta",
        "The query took too long and was stopped." => "A consulta demorou demais e foi encerrada.",
        "No accounts in this group" => "Nenhuma conta neste grupo",
        "Select which accounts belong to this group:" => "Selecione quais contas pertencem a este grupo:",
        "No accounts available" => "Nenhuma conta dispon\u{00ED}vel",
        "No groups yet. Create one above to run accounts together." => "Nenhum grupo ainda. Crie um acima para executar contas em conjunto.",
        "Distributing accounts" => "Distribuindo contas",
        "Distribute {} accounts?" => "Distribuir {} contas?",
        "Strategy: 1 account per server" => "Estrat\u{00E9}gia: 1 conta por servidor",
        "Launch all accounts of this group into the same game." => "Lan\u{00E7}a todas as contas deste grupo no mesmo jogo.",
        "Cancel" => "Cancelar",
        "Continue" => "Continuar",
        "Delete" => "Excluir",
        "Edit" => "Editar",
        ...
        "Waiting" => "Aguardando",
        "Failed" => "Falha",
        "Already running" => "J\u{00E1} em execu\u{00E7}\u{00E3}o",
        "accounts processed" => "contas processadas",
        "different servers used" => "servidores diferentes utilizados",
        "accounts started" => "contas iniciadas",
        "accounts could not be distributed" => "contas n\u{00E3}o puderam ser distribu\u{00ED}das",
        "Delete this group?" => "Excluir este grupo?",
        "This action removes the group configuration, but does not delete the accounts." => "Esta a\u{00E7}\u{00E3}o remover\u{00E1} a configura\u{00E7}\u{00E3}o do grupo, mas n\u{00E3}o excluir\u{00E1} as contas.",
        "Group saved" => "Grupo salvo",
        "Group deleted" => "Grupo exclu\u{00ED}do",
        "This account is already in the group" => "Esta conta j\u{00E1} est\u{00E1} no grupo",
        "Distribution cancelled" => "Distribui\u{00E7}\u{00E3}o cancelada",
        "Distribution failed" => "Falha na distribui\u{00E7}\u{00E3}o",
        "No server found for this account" => "Nenhum servidor encontrado para esta conta",
        "accounts distributed" => "contas distribu\u{00ED}das",
        "accounts not distributed" => "contas n\u{00E3}o distribu\u{00ED}das",
        "Create" => "Criar",
        "No Place ID configured" => "Nenhum Place ID configurado",
        "running" => "rodando",
        "No groups created" => "Nenhum grupo criado",
        "Create a group to organize multiple accounts in the same game." => "Crie um grupo para organizar v\u{00E1}rias contas em um mesmo jogo.",
